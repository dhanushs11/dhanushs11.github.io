            ...
            job.roles ? (
              ...
              >
                ...
                <div className="md:col-span-7">
                  <p className="text-hand text-xl text-muted md:hidden mb-4">{job.period}</p>
                  {job.roles.map((role, ri) => (
                    <div key={role.role} className="mb-8 last:mb-0">
                      <div className="flex items-center justify-between gap-4">
                        <h4 className="font-serif text-2xl text-ink leading-tight">
                          {role.role}
                        </h4>
                        {role.promoted && (
                          <span className="eyebrow text-accent-warm border border-accent-warm/40 rounded-full px-3 py-1 whitespace-nowrap">
                            ↑ promoted
                          </span>
                        )}
                      </div>
                      <p className="text-hand text-lg text-muted mt-1">{role.period}</p>
                      ...
                      {ri < job.roles.length - 1 && (
                        <div className="my-6 flex items-center gap-3 text-accent-warm/70">
                          <span className="text-hand text-lg">grown here</span>
                          <span className="flex-1 border-t border-dashed border-black/20" />
